const icon = document.querySelector(".region_temperature_details .data1 img")
const temp = document.querySelector(".region_temperature_details .data1 .temp .value");
const condition = document.querySelector(".region_temperature_details .data1 .condition");
const time = document.querySelector(".region_temperature_details .data1 .time");
const feel_temp = document.querySelector(".section2 .data2 .feel_temp span");        
const humidity = document.querySelector(".section2 .data2 .humidity span");
const uv_index = document.querySelector(".section2 .data2 .uv_index span");
const visibility = document.querySelector(".section2 .data2 .visibility span");
const cloud = document.querySelector(".section2 .data2 .cloud span");
const wind_direction = document.querySelector(".section2 .data2 .wind_direction span");
